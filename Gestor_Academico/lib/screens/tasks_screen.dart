                            ...
                            onPressed: () {
                              if (titleController.text.isNotEmpty &&
                                ...
                                final task = Task(
                                  ...
                                  subjectId: existingTask?.subjectId ?? subjectController.text,
      ...
      actions: [
        ...
        PopupMenuButton<String>(
          ...
          itemBuilder: (context) => const [
            PopupMenuItem(value: 'all', child: Text('Todas las tareas')),
            PopupMenuItem(value: 'pending', child: Text('Pendiente')),
            PopupMenuItem(value: 'completed', child: Text('Completado')),
            PopupMenuItem(value: 'high', child: Text('Alta prioridad')),
            PopupMenuItem(value: 'overdue', child: Text('Vencido')),
          ],
          child: const Padding(
